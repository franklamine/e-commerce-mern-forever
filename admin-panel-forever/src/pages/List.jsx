...
function List({token}) {
    ...
    const removeProduct = async (id) => {
        try {
            const response = await axios.post(backendUrl + "/api/forever/product/remove", {id},{headers:{token}});
            if (response.data.success) {
    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-2">
                ...
                {/*List Table Title*/}
                <div
                    className="hidden md:grid grid-cols-[1fr_3fr_1fr_1fr_1fr] items-center py-1 px-2 bg-gray-100 text-sm ">
                    <b>Image</b>
                    <b>Name</b>
                    <b>Category</b>
                    <b>Price</b>
